  ...
  return (
    <div ref={wrapRef} className="relative inline-flex shrink-0">
      ...
      {open && (
        <div
          role="status"
          className={`absolute left-1/2 top-full z-50 mt-1.5 -translate-x-1/2 rounded-[12px] border border-border bg-card px-3 py-2 text-[11.5px] font-medium leading-snug text-foreground shadow-[0_4px_10px_-4px_rgba(17,17,17,0.12)] ${popoverClassName}`}
        >
          {text}
        </div>
      )}
