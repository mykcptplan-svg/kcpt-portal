...
export function BreakfastIcon({ className }: { className: string }) {
  return (
    ...
    >
      ...
      <path d="M8 3c-.6.8-.6 1.5 0 2.3" />
      <path d="M12 3c-.6.8-.6 1.5 0 2.3" />
    </svg>
  );
}
...
export function TriggerSnackIcon({ className }: { className: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function DessertIcon({ className }: { className: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function RulerIcon({ className }: { className: string }) {
  return (
    ...
    >
      ...
      <path d="M7 9.5l.6 2M11 9l.6 2M15 8.5l.6 2" />
    </svg>
  );
}
